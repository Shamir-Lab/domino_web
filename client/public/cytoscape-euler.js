(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["cytoscapeEuler"] = factory();
  else root["cytoscapeEuler"] = factory();
})(this, function() {
    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function applySpring(spring) {
          ...
          var d = r - length;
          var coeff =
            (((!spring.coeff || spring.coeff < 0
              ? defaults.springCoeff
              : spring.coeff) *
              d) /
              r) *
            spring.weight;
        ...
        var Euler = (function(_Layout) {
          ...
          function Euler(options) {
            ...
            return _possibleConstructorReturn(
              this,
              (Euler.__proto__ || Object.getPrototypeOf(Euler)).call(
                this,
              ...
              if (!node.body) {
                ...
                if (isSamePosition(oldBody.pos, body.pos)) {
                  ...
                  do {
                    ...
                    retriesCount > 0 &&
                    isSamePosition(oldBody.pos, body.pos)
                  );
